...
export default function UiDashBoard() {
    return <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        <StaticCard title={"New Articles "} svg1={<GreenBoardSvg/>} svg2={<GreenUpSvg/>}/>
        <StaticCard title={" Upvotes"} svg1={<SvgRedBoard/>} svg2={<SvgRedDown/>}/>
        <TempCard title={"120 new comments"} desc={"200 comments"}/>
